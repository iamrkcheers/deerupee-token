(function () {
...
})()(
  {
    ...
    2: [
      ...
      { "./contract.js": 1, "truffle-contract-schema": 64 },
    ],
    3: [
      function (require, module, exports) {
        "use strict";
    ...
    4: [
      function (require, module, exports) {
        ...
        function Ajv(opts) {
          ...
          var schemaUriFormat = (this._schemaUriFormat =
            this._formats["uri-reference"]);
        ...
        function validateSchema(schema, throwOrLogError) {
          ...
          this._formats.uri =
            typeof currentUriFormat == "function"
    ...
    9: [
      function (require, module, exports) {
        ...
        function time(str, full) {
          ...
          return (
            hour <= 23 && minute <= 59 && second <= 59 && (!full || timeZone)
          );
        }
            ...
            function (
              ...
              if (typeof id == "string") {
                id = baseId = normalizeId(
                  baseId ? url.resolve(baseId, id) : id
                );
    ...
    15: [
      ...
      { "./ucs2length": 14, "fast-deep-equal": 50 },
    ],
    16: [
      function (require, module, exports) {
        "use strict";
              ...
              while (i6 < l6) {
                ...
                if (it.util.schemaHasRules($sch, it.RULES.all)) {
                  ...
                  $it.schemaPath =
                    it.schemaPath +
                    ".patternGroups" +
                    it.util.getProperty($pgProperty) +
                    ".schema";
                  $it.errSchemaPath =
                    it.errSchemaPath +
                    "/patternGroups/" +
                  ...
                  if ($pgMin !== undefined || $pgMax !== undefined) {
                    ...
                    if ($pgMin !== undefined) {
                      ...
                      out +=
                        ...
                        "; ";
                      $errSchemaPath =
                        it.errSchemaPath + "/patternGroups/minimum";
                      out += "  if (!" + $valid + ") {   ";
                      var $$outStack = $$outStack || [];
                      $$outStack.push(out);
                      out = "";
                      if (it.createErrors !== false) {
                        out +=
                          ...
                          $limit +
                          ", pattern: '" +
                          it.util.escapeQuotes($pgProperty) +
                          "' } ";
                        if (it.opts.messages !== false) {
                          out +=
                    ...
                    if ($pgMax !== undefined) {
                      ...
                      out +=
                        ...
                        "; ";
                      $errSchemaPath =
                        it.errSchemaPath + "/patternGroups/maximum";
                      out += "  if (!" + $valid + ") {   ";
                      var $$outStack = $$outStack || [];
                      $$outStack.push(out);
                      out = "";
    ...
    68: [
      function (require, module, exports) {
        module.exports = {
          ...
          _inBundle: false,
          _integrity:
            "sha512-nLlspmu1GKDaluWksBwitHi/7Z3IpRjmBYeO9N+T1nVJD2V4IWJaptCKP1NqnPiJA+FChB7+F7pI6Br51/FtXQ==",
          ...
          _requiredBy: ["/"],
          _resolved:
            "https://registry.npmjs.org/truffle-contract-schema/-/truffle-contract-schema-2.0.0.tgz",
          _shasum: "535378c0b6a7f58011ea8d84f57771771cb45163",
          _spec: "truffle-contract-schema@^2.0.0",
          _where:
            "/Users/user/Sites/consensys/release-4-0-7/truffle/dependencies/truffle-contract",
    ...
    78: [
      ...
      { "./support/isBuffer": 77, _process: 57, inherits: 76 },
    ],
    79: [
      function (require, module, exports) {
